...
public class cctv5HD extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cctv5_hd);
        PlayerView playerView8=findViewById( R.id.player_view8 );
        //得到默认合适的带宽
        ...
        // 创建player
        SimpleExoPlayer player8 = ExoPlayerFactory.newSimpleInstance(this, trackSelector);
        // 开始播放，绑定player对象
        playerView8.setPlayer(player8);
