...
public class cctv5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PlayerView playerView7=findViewById( R.id.player_view7 );
        //得到默认合适的带宽
        ...
        // 创建player
        SimpleExoPlayer player7 = ExoPlayerFactory.newSimpleInstance(this, trackSelector);
        // 开始播放，绑定player对象
        ...
        Uri uri=Uri.parse( "http://223.110.245.165/ott.js.chinamobile.com/PLTV/3/224/3221227381/index.m3u8" );
        MediaSource mediaSource1 = new HlsMediaSource.Factory(dataSourceFactory1).createMediaSource(uri);
        // 准备播放器的MediaSource
        player7.prepare(mediaSource1);
        // 当准备完毕后直接播放
