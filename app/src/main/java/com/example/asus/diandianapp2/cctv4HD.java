...
public class cctv4HD extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PlayerView playerView6=findViewById( R.id.player_view6 );
        //得到默认合适的带宽
        ...
        // 创建player
        SimpleExoPlayer player6 = ExoPlayerFactory.newSimpleInstance(this, trackSelector);
        // 开始播放，绑定player对象
        playerView6.setPlayer(player6);
